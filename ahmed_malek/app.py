...
# ========================== Config ==========================
global APP_URL
APP_URL = 'https://ahmedmalekacademy.e3lanotopia.software'
app = Flask(__name__)
app.secret_key = 'E3lanoTopia3024SchoolarSyncApi-1.0' 
app.config['PERMANENT_SESSION_LIFETIME'] = timedelta(days=30)
CLIENT_ID = "275922294832-dgts5acq7hr72skn1nk2qavdjh21q1b2.apps.googleusercontent.com"
CLIENT_SECRET = "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"
REDIRECT_URI = "https://ahmedmalekacademy.e3lanotopia.software/callback"
SCOPES = ['openid', 'email', 'profile']
app.config['HONEYBADGER_ENVIRONMENT'] = 'production'
app.config['HONEYBADGER_API_KEY'] = 'hbp_yDYubNjZdkllcnvCDoniSjxwUvZgy11GXIZb'
