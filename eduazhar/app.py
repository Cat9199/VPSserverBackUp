...
# ========================== Config ==========================
global APP_URL
APP_URL = 'https://eduazher.e3lanotopia.software/'
app = Flask(__name__)
app.secret_key = 'E3lanoTopia3024SchoolarSyncApi-1.0' 
app.config['PERMANENT_SESSION_LIFETIME'] = timedelta(days=30)
CLIENT_ID = "275922294832-u7f4kanbk82rl6ejg21jhk3tp57opt25.apps.googleusercontent.com"
CLIENT_SECRET = "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"
REDIRECT_URI = "https://eduazher.e3lanotopia.software/callback"
...
if __name__ == '__main__':
    port = int(os.environ.get('PORT', 4030))
